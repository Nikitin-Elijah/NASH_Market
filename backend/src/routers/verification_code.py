...
async def create_user(user: UserCreate):
    ...
    return VerificationCodeSchema(
        ...
        encode_id=db_verification_code.encode_id,
...
@router.post('/verify-code', response_model=UserSchema)
async def verify_code(verify_code: VerifyCodeSchema):
    ...
    db_verification_code = await VerificationCode.get(verify_code.id)
