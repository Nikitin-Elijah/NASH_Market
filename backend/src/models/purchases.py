...
class PurchaseModel(BaseModel):
    ...
    product: Mapped["ProductModel"] = relationship(
        "ProductModel", back_populates="purchases"
    )
    seller: Mapped["UserModel"] = relationship(
        "UserModel", back_populates="offers", foreign_keys=[seller_id]
    )
    buyer: Mapped["UserModel"] = relationship(
        "UserModel", back_populates="purchases", foreign_keys=[buyer_id]
    )
    review: Mapped["ReviewModel"] = relationship(
        "ReviewModel", back_populates="purchase"
    )
